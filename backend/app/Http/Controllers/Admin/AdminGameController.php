    ...
    protected function validateStepPayload(Request $request, string $step, Game $game): array
    {
        return match ($step) {
            ...
            'design' => $request->validate([
                ...
                'design.background_preset_id' => ['nullable', 'integer'],
                'design.border_preset' => ['required', 'string', 'max:50'],
                'design.wheel_border_preset_id' => ['nullable', 'integer'],
                'design.border_asset_path' => ['nullable', 'string', 'max:255'],
                'design.pointer_preset' => ['required', 'string', 'max:50'],
                'design.wheel_pointer_preset_id' => ['nullable', 'integer'],
                'design.wheel_pointer_asset_path' => ['nullable', 'string', 'max:255'],
                ...
                'design.banner_preset_id' => ['nullable', 'integer'],
                'design.banner_asset_path' => ['nullable', 'string', 'max:255'],
                'design.spin_button_preset_id' => ['nullable', 'integer'],
                'design.spin_button_asset_path' => ['nullable', 'string', 'max:255'],
                'design.extra_spin_button_preset_id' => ['nullable', 'integer'],
                'design.extra_spin_button_asset_path' => ['nullable', 'string', 'max:255'],
