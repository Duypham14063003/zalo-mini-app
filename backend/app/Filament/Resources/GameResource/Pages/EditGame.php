...
class EditGame extends EditRecord
{
    ...
    protected function mutateFormDataBeforeFill(array $data): array
    {
        ...
        return [
            ...
            'palette_preset' => data_get($draft, 'design.palette_preset', 'mint'),
            'background_preset_id' => data_get($draft, 'design.background_preset_id'),
            'border_preset' => data_get($draft, 'design.border_preset', 'pink-star'),
            'wheel_border_preset_id' => data_get($draft, 'design.wheel_border_preset_id'),
            'border_asset_path' => data_get($draft, 'design.border_asset_path'),
            'pointer_preset' => data_get($draft, 'design.pointer_preset', 'teardrop-gold'),
            'wheel_pointer_preset_id' => data_get($draft, 'design.wheel_pointer_preset_id'),
            'wheel_pointer_asset_path' => data_get($draft, 'design.wheel_pointer_asset_path'),
            'center_label' => data_get($draft, 'design.center_label', '19T'),
            'background_style' => data_get($draft, 'design.background_style', 'warm_gradient'),
            'background_asset_path' => data_get($draft, 'design.background_asset_path'),
            'banner_preset_id' => data_get($draft, 'design.banner_preset_id'),
            'banner_asset_path' => data_get($draft, 'design.banner_asset_path'),
            'spin_button_preset_id' => data_get($draft, 'design.spin_button_preset_id'),
            'spin_button_asset_path' => data_get($draft, 'design.spin_button_asset_path'),
            'extra_spin_button_preset_id' => data_get($draft, 'design.extra_spin_button_preset_id'),
            'extra_spin_button_asset_path' => data_get($draft, 'design.extra_spin_button_asset_path'),
    ...
    protected function handleRecordUpdate(Model $record, array $data): Model
    {
        ...
        $service->saveDraft($builderConfig->fresh(), 'design', [
            ...
            'background_preset_id' => $data['background_preset_id'] ? (int) $data['background_preset_id'] : null,
            'border_preset' => $data['border_preset'],
            'wheel_border_preset_id' => $data['wheel_border_preset_id'] ? (int) $data['wheel_border_preset_id'] : null,
            'border_asset_path' => $data['border_asset_path'] ?? null,
            'pointer_preset' => $data['pointer_preset'],
            'wheel_pointer_preset_id' => $data['wheel_pointer_preset_id'] ? (int) $data['wheel_pointer_preset_id'] : null,
            'wheel_pointer_asset_path' => $data['wheel_pointer_asset_path'] ?? null,
            'center_label' => $data['center_label'],
            'background_style' => $data['background_style'],
            'background_asset_path' => $data['background_asset_path'] ?? null,
            'banner_preset_id' => $data['banner_preset_id'] ? (int) $data['banner_preset_id'] : null,
            'banner_asset_path' => $data['banner_asset_path'] ?? null,
            'spin_button_preset_id' => $data['spin_button_preset_id'] ? (int) $data['spin_button_preset_id'] : null,
            'spin_button_asset_path' => $data['spin_button_asset_path'] ?? null,
            'extra_spin_button_preset_id' => $data['extra_spin_button_preset_id'] ? (int) $data['extra_spin_button_preset_id'] : null,
            'extra_spin_button_asset_path' => $data['extra_spin_button_asset_path'] ?? null,
